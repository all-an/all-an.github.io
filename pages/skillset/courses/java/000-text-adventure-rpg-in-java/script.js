// Lets the visitor override this course's status (done / planned / in
// progress) and persists the choice in localStorage, under the same key
// convention the courses list reads from: 'course-status:<folder-name>'.
// Also lets them bookmark individual steps, stored under the shared
// 'java-bookmarks' key that the bookmarks page (../bookmarks/) reads and
// manages.

const STORAGE_KEY = 'course-status:000-text-adventure-rpg-in-java';
const DEFAULT_STATUS = 'inprogress';

const COURSE_ID = '000-text-adventure-rpg-in-java';
const COURSE_NAME = 'Text Adventure RPG in Java';
const BOOKMARKS_KEY = 'java-bookmarks';
